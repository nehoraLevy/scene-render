...
public class Polygon extends Geometry
{
	...
	{
		this(vertices);
		this._plane._emission= new Color(c);
		//this._plane._material=new Material(0,0,0);
	 ...
	 * @param vertices
	 */
	public Polygon(Material material,Color c,Point3D... vertices)
	{
		this(c,vertices);
		_plane._material=new Material(material);
	}
